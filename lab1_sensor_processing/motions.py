...
class motion_executioner(Node):
    ...
    def __init__(self, motion_type=0):
        ...
        # qos = QoSProfile(
        #     reliability=QoSReliabilityPolicy.RELIABLE,  # Ensures messages are always delivered
        #     durability=QoSDurabilityPolicy.TRANSIENT_LOCAL,  # Messages persist for late subscribers
        #     history=QoSHistoryPolicy.KEEP_LAST,  # Only stores the last 'depth' messages
    ...
    def imu_callback(self, imu_msg: Imu):
        ...
        data = [
            ...
            imu_msg.angular_velocity.z,  # angular_z (rotation around Z-axis)
            timestamp  # stamp
        ]
    ...
    def laser_callback(self, laser_msg: LaserScan):
        ...
        data = [
            list(laser_msg.ranges),  # ranges (distance readings)
    ...
    def make_circular_twist(self):
        ...
        msg.angular.z = 0.2  # Rotate to make a circle 
        return msg
    ...
    def make_acc_line_twist(self):
        msg=Twist() # fill up the twist msg for line motion
        msg.linear.x = 0.3  # Move straight
